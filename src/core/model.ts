 ...
 *
 * Loaders (src/core/load-*.ts) parse the raw YAML/Markdown/shell sources into
 * these shapes; adapters (src/adapters/**) consume them and never re-read core/.
...
/** A validation finding produced by src/core/validate.ts and adapters. */
